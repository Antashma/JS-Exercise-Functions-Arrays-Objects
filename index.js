...
function sayGoodbye(user) {
  return `Goodbye, ${user}. Have a great day.`
}

console.log('CHALLENGE sayGoodbye:')
console.log(sayGoodbye('Samantha'));
...
function temperatureCtoF(tempCel) {
  ...
  return Math.round(tempFah);
}
console.log('CHALLENGE temperatureCtoF:')
...
function getCarInfoByIndex(inventory, index) {
  return `This is the ${inventory[index].car_make} ${inventory[index].car_model}`;
}
console.log('CHALLENGE getCarInfoByIndex:')
console.log(getCarInfoByIndex(inventory, 10))
/**
...
function getCarInfoById(arr, id) {
  for (i in arr) {
    if (arr[i].id === id) {
      return `This is the ${arr[i].car_make} ${arr[i].car_model}`;
    } 
  }
}
console.log('STRETCH getCarInfoById:');
